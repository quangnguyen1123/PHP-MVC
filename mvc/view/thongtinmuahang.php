                                ...
                                <table id="datatablesSimple" class="dataTable-table">
                                    <thead>
                                       <tr>
                                            ...
                                            <th  class="row1"  scope="col">Email</th>
                                    ...
                                    <?php
                                        foreach ($thongtinmuahang as $item) {   
                                    ?>
                                    <tr >
                                        ...
                                        <td class="row1" ><?php echo $item['email'] ?></td>
                                        ...
                                        <td class="row1" >
                                            <a href="xoathongtinmuahang?Id=<?php echo $item['Id']?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
