                ...
                <main>
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div id="form">
                            ...
                            <div>
                                <a href="themsp"><button type="button" class="btn btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-square-fill" viewBox="0 0 16 16">
                            ...
                            <div class="dataTable-container">
                                <table id="datatablesSimple" class="dataTable-table">
                                    ...
                                    <?php
                                        foreach ($quantri as $item) {   
                                    ?>
                                    <tr >

                                        <td class="row1" ><img src="http://localhost/websitemvc12/public/anh/<?php echo $item['tenanh']?>"  width="50" height="50"> </td>
                                        <td class="row1" ><?php echo $item['masp'] ?> </td>
                                        <td class="row1" ><?php echo $item['tensp']?></td>
                                        <td class="row1" ><?php echo $item['tendanhmuc'] ?></td>
                                        
                                        <td class="row1" ><?php echo $item['gia'] ?> đ</td>
                                        <td class="row1" ><?php echo $item['gianhap'] ?> đ </td>
                                        <td class="row1" ><?php echo $item['ngaysx']?></td>
                                        </td>
                                        <td class="row1" >
                                            <a href="suasp?id=<?php echo $item['idsp'] ?>">
                                        ...
                                        <td class="row1" >
                                            <a href="xoasp?id=<?php echo $item['idsp'] ?>"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
                                    ...
                                    <nav aria-label="Page navigation example">
                                      <ul class="pagination">
                                        <?php
                                            ...
                                            ?>
                                          <li class="page-item"><a class="page-link" href="quantri?page=<?php echo $item['page'];?>"><?php echo $item['page'];?></a></li>
                                          <?php
                                              }
                                              ?>
